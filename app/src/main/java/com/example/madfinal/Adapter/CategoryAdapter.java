package com.example.madfinal.Adapter;
...
import com.example.madfinal.Activity.ListFoodsActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.viewholder holder, int position) {
           ...
           int drawableResource = context.getResources().getIdentifier(items.get(position).getImagePath(),
